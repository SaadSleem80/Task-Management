    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-v1-login">User Login</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-POSTapi-v1-logout">
                                <a href="#auth-POSTapi-v1-logout">User Logout</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="auth">Auth</h1>
                                ...
                                <h2 id="auth-POSTapi-v1-login">User Login</h2>
...
<p>Must be at least 8 characters. Must not be greater than 255 characters. Example: <code>+-0pBNvYgxwmi/#iw</code></p>
                    ...
                    <h2 id="auth-POSTapi-v1-logout">User Logout</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="tasks">Tasks</h1>
                                ...
                                <h2 id="tasks-GETapi-v1-tasks">Get all tasks</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/tasks?search=architecto&amp;user_id=16&amp;parent_id=16&amp;status=architecto&amp;paginate=16&amp;sort_by=architecto&amp;sort_type=architecto&amp;start_date=architecto&amp;end_date=architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
    ...
    <br>
<p>optional Search by title or description Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               step="any"               name="user_id"                data-endpoint="GETapi-v1-tasks"
               value="16"
               data-component="query">
    <br>
<p>optional Search by user id Example: <code>16</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="parent_id"                data-endpoint="GETapi-v1-tasks"
               value="16"
               data-component="query">
    <br>
<p>optional Search by parent id Example: <code>16</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>optional Search by status | pending, completed, cancelled Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="paginate"                data-endpoint="GETapi-v1-tasks"
               value="16"
               data-component="query">
    <br>
<p>optional Paginate results Example: <code>16</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>optional Sort by column Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>sort_type</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="sort_type"                data-endpoint="GETapi-v1-tasks"
               value="architecto"
               data-component="query">
    <br>
<p>optional Sort type Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="start_date"                data-endpoint="GETapi-v1-tasks"
               value="architecto"
               data-component="query">
    <br>
<p>optional Search by start date Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="end_date"                data-endpoint="GETapi-v1-tasks"
               value="architecto"
               data-component="query">
    <br>
<p>optional Search by end date Example: <code>architecto</code></p>
            </div>
                </form>

                    <h2 id="tasks-GETapi-v1-tasks--id-">Get a task by id</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/tasks/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/tasks/architecto"
);
...
<p>The ID of the task. Example: <code>architecto</code></p>
                    ...
                    <h2 id="tasks-POSTapi-v1-tasks">Create a new task</h2>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="parent_id"                data-endpoint="POSTapi-v1-tasks"
               value=""
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="2025-10-05T02:27:58"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-10-05T02:27:58</code></p>
        </div>
        </form>

                    <h2 id="tasks-PUTapi-v1-tasks--id-">Update a task by id</h2>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="user_id"                data-endpoint="PUTapi-v1-tasks--id-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="parent_id"                data-endpoint="PUTapi-v1-tasks--id-"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the tasks table.</p>
...
<ul style="list-style-type: square;"><li><code>pending</code></li> <li><code>in_progress</code></li> <li><code>completed</code></li></ul>
                    ...
                    <h2 id="tasks-DELETEapi-v1-tasks--id-">Delete a task by id</h2>
